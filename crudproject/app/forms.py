...
class customerform(forms.ModelForm):
    ...
    address= forms.CharField(label='Your name',widget=forms.Textarea(attrs={'class':'form-control', 'placeholder':'Name here','row':'03','cols':'50'}),error_messages={'required':'Must enter the right address'})
